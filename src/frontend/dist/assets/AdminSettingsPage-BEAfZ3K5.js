import { r as reactExports, j as jsxRuntimeExports, R as React, e as cn, a as useBackend, u as useAuth, f as useQueryClient, b as useQuery, g as useMutation, S as Spinner, d as ue } from "./index-DJqSJyUM.js";
import { A as AdminLayout, S as Settings } from "./AdminLayout-Dk4cUZpS.js";
import { B as Button } from "./button-DFRBYKs0.js";
import { L as Label, I as Input } from "./label-BdFXT_5g.js";
import { b as composeRefs, u as useComposedRefs } from "./index-DQpP8u8x.js";
...
function AdminSettingsPage() {
  ...
  function handleDisplayNameChange(value) {
    setLocalSettings(
      (prev) => prev ? { ...prev, appDisplayName: value } : prev
    );
    setIsDirty(true);
  }
  function handleCommissionChange(value) {
    ...
    if (!Number.isNaN(bps)) {
      setLocalSettings(
        (prev) => prev ? { ...prev, commissionRateBps: BigInt(bps) } : prev
      );
      setIsDirty(true);
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-xl space-y-6 px-4 py-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-full bg-accent/15", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "h-5 w-5 text-accent" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-bold text-foreground", children: "App Settings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Configure platform features and branding" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
    ...
    isLoading || !localSettings ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-4 font-display text-sm font-semibold text-foreground", children: "Branding" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Label,
              {
                htmlFor: "commission",
                className: "text-xs font-medium text-muted-foreground",
                children: "Commission Rate (basis points, e.g. 100 = 1%)"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-4 font-display text-sm font-semibold text-foreground", children: "Feature Toggles" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: TOGGLE_SETTINGS.map(({ field, label, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
