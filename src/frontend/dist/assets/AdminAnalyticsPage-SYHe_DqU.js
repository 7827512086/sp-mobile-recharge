import { C as commonjsGlobal, D as getDefaultExportFromCjs, r as reactExports, k as clsx, E as React, F as invariant, a as useBackend, b as useQuery, T as TransactionStatus, j as jsxRuntimeExports, S as Spinner, e as cn } from "./index-DJqSJyUM.js";
import { A as AdminLayout, C as ChartColumn } from "./AdminLayout-Dk4cUZpS.js";
import { E as EmptyState } from "./EmptyState-j5cN7fLp.js";
import { O as OPERATOR_INFO, a as formatBalance, f as formatTimestamp } from "./types-DAsELOtn.js";
...
var arrayMap$1 = _arrayMap, baseGet = _baseGet, baseIteratee$4 = _baseIteratee, baseMap$1 = _baseMap, baseSortBy = _baseSortBy, baseUnary = _baseUnary, compareMultiple = _compareMultiple, identity$9 = identity_1, isArray$3 = isArray_1;
...
var arrayMap = _arrayMap, baseIteratee$3 = _baseIteratee, baseMap = _baseMap, isArray$2 = isArray_1;
...
function AdminAnalyticsPage() {
  ...
  const chartData = (analytics == null ? void 0 : analytics.byOperator.map((row, i) => {
    var _a;
    return {
      name: ((_a = OPERATOR_INFO[row.operator]) == null ? void 0 : _a.name) ?? String(row.operator),
  ...
  const filteredTx = (transactions ?? []).filter(
    (tx) => statusFilter === "all" ? true : tx.status === statusFilter
  );
  const totalRevenue = (analytics == null ? void 0 : analytics.totalRevenue) ?? 0n;
  const totalCount = (analytics == null ? void 0 : analytics.totalCount) ?? 0n;
  const avgValue = totalCount > 0n ? formatBalance(totalRevenue / totalCount) : formatBalance(0n);
  const top3 = [...(analytics == null ? void 0 : analytics.byOperator) ?? []].sort((a2, b2) => Number(b2.totalRevenue - a2.totalRevenue)).slice(0, 3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl px-4 pt-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-bold text-foreground", children: "Analytics" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Revenue and recharge performance overview" })
    ] }),
    analyticsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {}) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 grid grid-cols-3 gap-4", children: [
        {
          label: "Total Revenue",
      ...
      ].map(({ label, value, accent, ocid }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          "data-ocid": ocid,
          className: "rounded-2xl border border-border bg-card p-4",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-1 text-[10px] font-semibold uppercase tracking-wide text-muted-foreground", children: label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: cn("font-mono text-xl font-bold", accent), children: value })
          ]
        },
        label
      )) }),
      top3.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          "data-ocid": "admin.analytics.top_operators_section",
          className: "mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3",
          children: top3.map((row, i) => {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: op.name })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: medals[i] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-3 w-3 text-accent" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-lg font-bold text-accent", children: formatBalance(row.totalRevenue) })
                    ] }),
      ...
      chartData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-4 font-display text-sm font-semibold uppercase tracking-wide text-muted-foreground", children: "Revenue by Operator (INR)" }),
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Tooltip,
                    {
                      ...
                      formatter: (v2) => [`₹${v2.toFixed(2)}`, "Revenue"]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "revenue", radius: [6, 6, 0, 0], children: chartData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.fill }, entry.name)) })
                ]
              }
            ) })
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 border-b border-border px-5 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-sm font-semibold text-foreground", children: "All Transactions" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1", children: STATUS_FILTERS.map(({ value, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: cn(
                  ...
                  statusFilter === value ? "bg-accent/15 text-accent ring-1 ring-accent/30" : "text-muted-foreground hover:text-foreground"
                ),
                children: label
              },
              value
          ...
          txLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {}) }) : filteredTx.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              "data-ocid": "admin.analytics.transactions.empty_state",
              className: "py-10 text-center text-sm text-muted-foreground",
              children: "No transactions match this filter."
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-2.5 text-left text-[10px] font-semibold uppercase tracking-wide text-muted-foreground", children: "Date" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2.5 text-left text-[10px] font-semibold uppercase tracking-wide text-muted-foreground", children: "User" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-2.5 text-center text-[10px] font-semibold uppercase tracking-wide text-muted-foreground", children: "Status" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: filteredTx.map((tx, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "tr",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground", children: formatTimestamp(tx.timestamp) }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-muted-foreground", children: shortId }) }),
